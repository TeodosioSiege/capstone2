...
$data = "<div class='container table-responsive'><table class='table table-striped'>
    <thead>
      <tr>
...
if (mysqli_num_rows($result) > 0) {
	while ($row = mysqli_fetch_assoc($result)) {
		$data .= "
<tr><td>$row[Ref_Number]</td><td>$row[Customer_Name]</td><td>$row[product_name]</td><td>$row[Quantity]</td><td>$row[Status]</td>
